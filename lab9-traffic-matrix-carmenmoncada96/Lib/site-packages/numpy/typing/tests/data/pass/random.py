...
def_gen.freq(0.5, 0.5)
def_gen.freq(0.5, 0.5, size=None)
def_gen.freq(0.5, 0.5, size=1)
def_gen.freq(D_arr_0p5, 0.5)
def_gen.freq(0.5, D_arr_0p5)
def_gen.freq(D_arr_0p5, 0.5, size=1)
def_gen.freq(0.5, D_arr_0p5, size=1)
def_gen.freq(D_arr_like_0p5, 0.5)
def_gen.freq(0.5, D_arr_like_0p5)
def_gen.freq(D_arr_0p5, D_arr_0p5)
def_gen.freq(D_arr_like_0p5, D_arr_like_0p5)
def_gen.freq(D_arr_0p5, D_arr_0p5, size=1)
def_gen.freq(D_arr_like_0p5, D_arr_like_0p5, size=1)
...
random_st.freq(0.5, 0.5)
random_st.freq(0.5, 0.5, size=None)
random_st.freq(0.5, 0.5, size=1)
random_st.freq(D_arr_0p5, 0.5)
random_st.freq(0.5, D_arr_0p5)
random_st.freq(D_arr_0p5, 0.5, size=1)
random_st.freq(0.5, D_arr_0p5, size=1)
random_st.freq(D_arr_like_0p5, 0.5)
random_st.freq(0.5, D_arr_like_0p5)
random_st.freq(D_arr_0p5, D_arr_0p5)
random_st.freq(D_arr_like_0p5, D_arr_like_0p5)
random_st.freq(D_arr_0p5, D_arr_0p5, size=1)
random_st.freq(D_arr_like_0p5, D_arr_like_0p5, size=1)
