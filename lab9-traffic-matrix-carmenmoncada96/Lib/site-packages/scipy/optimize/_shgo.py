...
class SHGO:
    ...
    def find_lowest_vertex(self):
        ...
        if self.sampling_method == 'simplicial':
            ...
            for x in self.HC.V.cache:
                if self.HC.V[x].freq < self.f_lowest:
                    self.f_lowest = self.HC.V[x].freq
    ...
    def simplex_minimizers(self):
        ...
        for x in self.HC.V.cache:
            if self.HC.V[x].minimiser():
                if self.disp:
                    ...
                    logging.info('v.f = {} is minimizer'.format(self.HC.V[x].freq))
                    logging.info('=' * 30)
                ...
                if self.disp:
                    ...
                    for vn in self.HC.V[x].nn:
                        logging.info('x = {} || f = {}'.format(vn.x, vn.freq))
        ...
        for v in self.minimizer_pool:
            ...
            self.minimizer_pool_F.append(v.freq)
