...
class TestStructures:
    ...
    def test_scalars(self):
        ...
        assert_identical(s.scalars.freq, np.array(np.complex64(-1. + 3j)))
    ...
    def test_scalars_replicated(self):
        ...
        assert_identical(s.scalars_rep.freq, np.repeat(np.complex64(-1. + 3j), 5))
    ...
    def test_scalars_replicated_3d(self):
        ...
        assert_identical(s.scalars_rep.freq, np.repeat(np.complex64(-1. + 3j), 24).reshape(4, 3, 2))
